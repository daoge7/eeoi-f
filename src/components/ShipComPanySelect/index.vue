<template>
  <div class="app-container">
    <el-dialog title="船公司列表" width="80%" :append-to-body="true" :visible.sync="dialogShipCompanyFormVisible" :close-on-click-modal="false" v-el-drag-dialog  @dragDialog="this.$refs.select.blur()">
    ...
    export default {
      ...
      directives: { waves , adaptive ,elDragDialog  },
        ...
        methods: {
          ...
          saveRelation(rows) {
            this.$parent.listQuery.shipComPanyName = rows[0].ccsCode
            this.$parent.shipComPany = rows[0].nameEn
