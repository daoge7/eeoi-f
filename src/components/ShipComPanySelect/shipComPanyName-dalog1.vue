<template>
  <div class="app-container">
    <el-dialog title="船公司列表" width="80%" :append-to-body="shipComPanyNamevicode" :visible.sync="shipComPanyNamevicode" :before-close="addDetale">
...
<script>
    ...
    export default {
      ...
      created(){
        ...
        methods: {
          addDetale() {
              this.$emit('shipComPanyNameData1', false)
          },  
          saveRelation() {
             let obj = {}
          ...
          this.$emit('shipComPanyNameData1', obj)
          },
