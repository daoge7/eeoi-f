  ...
  <div class="app-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline" style="margin-top:10px;">
        <el-form-item :label="$t('Statistics.shipCompany')">
          <div style="display:flex">
            <el-input v-model="comPanyName" disabled style="margin-right:5px;" />
            <el-button @click="shipCompany">{{ $t('common.select') }}</el-button>
          </div>
        </el-form-item>
        <el-form-item :label="$t('Statistics.shipName')">
          <div style="display:flex">
            <el-input v-model="shipsName" disabled style="margin-right:5px;" />
            <el-button @click="shipName">{{ $t('common.select') }}</el-button>
          </div>
        </el-form-item>
    ...
    >
      <el-table-column :label="$t('Statistics.AnnualDataPer')" align="center">
        ...
        <el-table-column
          :label="$t('Statistics.FreightVolume')"
          width="auto"
          align="center"
          show-overflow-tooltip
          :render-header="renderheader"
        ...
        <el-table-column
          :label="$t('Statistics.voyageMileage')"
          width="auto"
          align="center"
          show-overflow-tooltip
          :render-header="renderheader"
        ...
        <el-table-column
          :label="$t('Statistics.NoLoadMileage')"
          width="auto"
          align="center"
          show-overflow-tooltip
          :render-header="renderheader"
        ...
        <el-table-column
          :label="$t('Statistics.TurnoverVolume')"
          width="auto"
          align="center"
          show-overflow-tooltip
          :render-header="renderheader"
        ...
        <el-table-column
          :label="$t('Statistics.BoxTurnover')"
          width="auto"
          align="center"
          show-overflow-tooltip
          :render-header="renderheader"
    ...
    handleExport() {
      ...
      if (this.comPanyName || this.shipsName) {
        downLoadSigalShip(obj).then(res => {
          this.download(res.data, "单船年度能效数据.xls");
          this.$notify({
            title: "Success",
