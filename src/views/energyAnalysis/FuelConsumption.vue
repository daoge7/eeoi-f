<template>
  <div class="app-container">
    <div class="filter-container">
      <div style="display:flex;align-items: center;">
        ...
        <div style="padding:10px 10px 0; display:flex;align-items: center;">
          ...
          <el-select
            v-model="listQuery.shipTypeCode"
        ...
        <div style="padding:10px 10px 0; display:flex;align-items: center;">
          ...
          <el-select
            v-model="listQuery.shipAgeRange"
            :placeholder="$t('common.selectRemind')"
            clearable
            class="filter-item"
            style="width: 130px"
      ...
      <div style="display:flex;align-items: center;">
        ...
        <div style="padding:10px 10px 0; display:flex;align-items: center;">
          ...
          >
            <el-option
              v-for="item in rollingCycleUnitOptions"
              :key="item.key"
      ...
      <div style="display:inline-block;">
        ...
        <el-col :span="22.5">
          ...
          >
            <el-checkbox
              v-for="(item, index) in analyzeItems"
              :key="index"
              style="margin-right: 10px;"
              :label="item.key"
    ...
    >
      <el-tab-pane
        :key="'first'"
        :label="$t('Analysis.AnalysisChart')"
        name="first"
      >
      ...
      >
        ...
        >
          ...
          <el-table-column
            :label="$t('Analysis.fuelPerTransport')"
            width="auto"
            align="center"
            :render-header="renderheader"
          >
          ...
          <el-table-column
            :label="$t('Analysis.reductionRatio')"
            width="auto"
            align="center"
          ...
          <el-table-column
            :label="$t('Analysis.loadUtilization')"
            width="120"
            align="center"
            show-overflow-tooltip
          >
    ...
    <shipComPanyName
      ...
      :ship-com-pany-namevicode="dialogShipCompanyFormVisibles"
...
import {
  getEnergyEfficencyTrend,
  getEnergyEfficencyTrendData,
  downLoadEnergyEfficencyTrendData
...
import shipComPanyName from "./components/shipComPanyName-dalog";

const rollingCycleUnitOptions = [
...
export default {
  ...
  methods: {
    ...
    shipComPanyNameData(val) {
      console.log("shipComPanyNameData", val);
    ...
    getChartData() {
      getEnergyEfficencyTrend(this.listQuery).then(res => {
        ...
        if (res.data.data.shipComPanyName && res.data.data.shipName) {
          this.chartTitle =
            res.data.data.shipComPanyName +
            "公司/" +
            res.data.data.shipName +
            "船舶 能效趋势分析";
        }
        if (res.data.data.shipComPanyName && !res.data.data.shipName) {
